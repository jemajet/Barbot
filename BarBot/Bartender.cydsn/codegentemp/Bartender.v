// ======================================================================
// Bartender.v generated from TopDesign.cysch
// 06/17/2020 at 01:23
...
module top ;
	...
	wire [0:0] tmpOE__Relay_1_net;
	wire [0:0] tmpFB_0__Relay_1_net;
	wire [0:0] tmpIO_0__Relay_1_net;
	wire [0:0] tmpINTERRUPT_0__Relay_1_net;
	electrical [0:0] tmpSIOVREF__Relay_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		Relay_1
		 (.oe(tmpOE__Relay_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Relay_1_net[0:0]}),
		  .io({tmpIO_0__Relay_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Relay_1_net),
		  .interrupt({tmpINTERRUPT_0__Relay_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Relay_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Submit_Button_net;
	wire [0:0] tmpIO_0__Submit_Button_net;
	wire [0:0] tmpINTERRUPT_0__Submit_Button_net;
	electrical [0:0] tmpSIOVREF__Submit_Button_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Submit_Button
		 (.oe(tmpOE__Submit_Button_net),
		  .y({1'b0}),
		  .fb({Net_15}),
		  .io({tmpIO_0__Submit_Button_net[0:0]}),
		  .siovref(tmpSIOVREF__Submit_Button_net),
		  .interrupt({tmpINTERRUPT_0__Submit_Button_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Submit_Button_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Debouncer_v1_0 Submit_Debouncer (
        .d(Net_15),
        .clock(Net_23),
        .q(Net_58),
        .neg(Net_25),
        .either(Net_59),
        .pos(Net_60));
    defparam Submit_Debouncer.EitherEdgeDetect = 0;
    defparam Submit_Debouncer.NegEdgeDetect = 1;
    defparam Submit_Debouncer.PosEdgeDetect = 0;
    defparam Submit_Debouncer.SignalWidth = 1;


	cy_clock_v1_0
		#(.id("035eadc1-7fc0-4233-b31b-97e377ff8b25"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("14492753623188.4"),
		  .is_direct(0),
		  .is_digital(1))
		Debounce_Clock
		 (.clock_out(Net_23));
	...
	wire [0:0] tmpOE__Relay_2_net;
	wire [0:0] tmpFB_0__Relay_2_net;
	wire [0:0] tmpIO_0__Relay_2_net;
	wire [0:0] tmpINTERRUPT_0__Relay_2_net;
	electrical [0:0] tmpSIOVREF__Relay_2_net;

	cy_psoc3_pins_v1_10
		#(.id("840a2bde-f104-4ec8-9904-c7cdfd2e0dcf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Relay_2
		 (.oe(tmpOE__Relay_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Relay_2_net[0:0]}),
		  .io({tmpIO_0__Relay_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Relay_2_net),
		  .interrupt({tmpINTERRUPT_0__Relay_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Relay_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Relay_3_net;
	wire [0:0] tmpFB_0__Relay_3_net;
	wire [0:0] tmpIO_0__Relay_3_net;
	wire [0:0] tmpINTERRUPT_0__Relay_3_net;
	electrical [0:0] tmpSIOVREF__Relay_3_net;

	cy_psoc3_pins_v1_10
		#(.id("74d44ed6-de37-4da5-bdb0-914c683d0cac"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Relay_3
		 (.oe(tmpOE__Relay_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Relay_3_net[0:0]}),
		  .io({tmpIO_0__Relay_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Relay_3_net),
		  .interrupt({tmpINTERRUPT_0__Relay_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Relay_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Relay_4_net;
	wire [0:0] tmpFB_0__Relay_4_net;
	wire [0:0] tmpIO_0__Relay_4_net;
	wire [0:0] tmpINTERRUPT_0__Relay_4_net;
	electrical [0:0] tmpSIOVREF__Relay_4_net;

	cy_psoc3_pins_v1_10
		#(.id("1334299f-da09-40b8-9491-a157045496f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Relay_4
		 (.oe(tmpOE__Relay_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Relay_4_net[0:0]}),
		  .io({tmpIO_0__Relay_4_net[0:0]}),
		  .siovref(tmpSIOVREF__Relay_4_net),
		  .interrupt({tmpINTERRUPT_0__Relay_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Relay_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Relay_5_net;
	wire [0:0] tmpFB_0__Relay_5_net;
	wire [0:0] tmpIO_0__Relay_5_net;
	wire [0:0] tmpINTERRUPT_0__Relay_5_net;
	electrical [0:0] tmpSIOVREF__Relay_5_net;

	cy_psoc3_pins_v1_10
		#(.id("6b97bf61-475a-4dbd-a51d-bacfc8c525e0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Relay_5
		 (.oe(tmpOE__Relay_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Relay_5_net[0:0]}),
		  .io({tmpIO_0__Relay_5_net[0:0]}),
		  .siovref(tmpSIOVREF__Relay_5_net),
		  .interrupt({tmpINTERRUPT_0__Relay_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Relay_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Relay_6_net;
	wire [0:0] tmpFB_0__Relay_6_net;
	wire [0:0] tmpIO_0__Relay_6_net;
	wire [0:0] tmpINTERRUPT_0__Relay_6_net;
	electrical [0:0] tmpSIOVREF__Relay_6_net;

	cy_psoc3_pins_v1_10
		#(.id("dfb99323-e1df-4942-bb31-0b2f6592a515"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Relay_6
		 (.oe(tmpOE__Relay_6_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Relay_6_net[0:0]}),
		  .io({tmpIO_0__Relay_6_net[0:0]}),
		  .siovref(tmpSIOVREF__Relay_6_net),
		  .interrupt({tmpINTERRUPT_0__Relay_6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Relay_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("52b0a63e-78c5-4bc2-a66d-8a643e43f619"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    Debouncer_v1_0 Up_Debouncer (
        ...
        .either(Net_395),
        .pos(Net_396));
    defparam Up_Debouncer.EitherEdgeDetect = 0;
    defparam Up_Debouncer.NegEdgeDetect = 1;
    defparam Up_Debouncer.PosEdgeDetect = 1;
    defparam Up_Debouncer.SignalWidth = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("e06ea52e-840e-4a4e-b7a1-50848428608b"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    Debouncer_v1_0 Down_Debouncer (
        ...
        .either(Net_66),
        .pos(Net_67));
    defparam Down_Debouncer.EitherEdgeDetect = 0;
    defparam Down_Debouncer.NegEdgeDetect = 1;
    defparam Down_Debouncer.PosEdgeDetect = 0;
    defparam Down_Debouncer.SignalWidth = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("8bfd827c-ee98-428c-a193-cce545241485"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("35a9b638-5c61-45a0-b04a-aff8953f9554"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
